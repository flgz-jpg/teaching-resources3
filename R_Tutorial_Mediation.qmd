...
Dieses R Tutorial ist begleitend für die Input-Sitzung "Mediationsanalyse" des Masterkolloquiums Forenische Psychologie an der Univserisität Basek konzipiert worden. Den Datensatz zur Lösung der Aufgaben finden Teilnehmende des Masterkollquiums auf der Learning Platform ADAM.
...
```{mermaid}
graph LR
    A[Emotionale Instabilität] -- Kein / Kleiner Effekt --> B[Bestrafung]
    A -- Signifikanter Effekt --> C[Hostiler Attributionsstil]
    C -- Signifikanter Effekt --> B[Bestrafung]
```
:::
...
Lesen Sie den Datensatz data.csv ein, die Ihnen über ADAM zur Verfügung gestellt wurde.
...
2.  Mediationsanalyse nach Barron und Kenny
